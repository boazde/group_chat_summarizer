...
def main_app():
    ...
    if st.button("Generate Summary"):
        if not chat_export_file or not summary_file or not openai_key:
            ...
            main(chat_type, chat_export_file.name, summary_file, start_date_str, end_date_str, newsletter, openai_key)
